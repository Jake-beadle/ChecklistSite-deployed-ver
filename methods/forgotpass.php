...
if ($emailTest == 0) { 
    ...
    $mail->Body    = "Hello ".$username.",<br>A password reset was requested for this email, which expires in 15 minutes. You can reset your password using this link, which expires in 15 minutes: <a href=".$passResetLink.">".$passResetLink."</a>.<br>If you didn't request this, please ignore this email, and for any further assistance, please notify admins";
    $mail->send();
